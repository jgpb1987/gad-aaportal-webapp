...
namespace gad.aaportal.models.Entity.Dbo
{
    public partial class DatosIngreso
    {
        public DatosIngreso()
        {
            RtPagoBancos = new HashSet<RtPagoBanco>();
        ...
        public virtual Ciudadano CodClienteIngresoNavigation { get; set; } = null!;
        public virtual ICollection<RtPagoBanco> RtPagoBancos { get; set; }
